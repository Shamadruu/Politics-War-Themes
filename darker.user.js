...
(function(){
	...
	addGlobalStyle('body p, h3, form, #leftcolumn,body table.nationtable { color:#fff;}');
	...
	addGlobalStyle('#header, div.container:nth-child(10) > div:nth-child(1) {background-color: #17191c;}');
})();